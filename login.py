...
#
label_l1 = tk.Label(root, text="CYBER BULLYING USING TWITTER",font=("Times New Roman", 30, 'bold'),
                    background="gray", fg="white", width=67, height=2)
label_l1.place(x=0, y=0)

img = Image.open('ic.png')
...
button1 = tk.Button(label_l1, text="HOME", command=log, width=10, height=1,font=('times 15 bold underline'),bd=0, bg="gray", fg="white")
button1.place(x=1170, y=50)

button2 = tk.Button(label_l1, text="REGISTER",command=con,width=13, height=1,font=('times 15 bold underline'), bd=0,bg="gray", fg="white")
button2.place(x=1290, y=50)

button4 = tk.Button(label_l1, text="EXIT", command=window, width=10, height=1,font=('times 15 bold underline'),bd=0,bg="gray", fg="white")
